...
| Box simulation (DistVol + box size for cohort) | `box_simulation.py [SHIP_TAG] [--refresh] [--distvol <xlsx>]` (`--distvol` > `DISTVOL_XLSX` env > Desktop default) | ✅ | inline DistVol regex |
