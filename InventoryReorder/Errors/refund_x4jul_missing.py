...
"""Bulk partial refund — AHB-X4JUL fulfilled orders shipped missing AC-KETT + AC-RHB.

13 fulfilled Independence Day boxes went out without the Red White & Blue Kettle Corn
and Raspberry Hibiscus Jam. $15 goodwill refund each (matches the $15 already given to
#154327 Payne). #153153 Sloan ($10) + #154327 Payne ($15) already refunded — excluded.

Usage:
    python refund_x4jul_missing.py            # dry-run
    python refund_x4jul_missing.py --commit   # apply
"""
...
# ──────────────────────────────────────────────
XLSX_PATH = r"C:\Users\Work\Claude Projects\_outputs\cache\x4jul_missing_refund.xlsx"
REFUND_AMOUNT = 15.00
REFUND_NOTE = "X4JUL missing AC-KETT+AC-RHB — $15 goodwill refund issued"
SKIP_ORDERS = set()
SKIP_LAST_N_ROWS = 0
ORDER_COL = 0
# ──────────────────────────────────────────────
