...
"""Bulk partial refund — _SHIP_2026-06-29 CH-TTBRIE OOS ($8 each).
Copied fresh from _template_bulk_refund.py. Dry-run by default; --commit to apply.
Idempotent (checks for existing refund matching the note)."""
...
# CUSTOMIZE THESE
# ──────────────────────────────────────────────
XLSX_PATH = r"C:\Users\Work\Claude Projects\AppyHour\InventoryReorder\Errors\ship0629_blracl.xlsx"
REFUND_AMOUNT = 24.00
REFUND_NOTE = "SHIP 0629 BL-RACL bundle OOS — $24 refund issued"
SKIP_ORDERS = set()
SKIP_LAST_N_ROWS = 0
ORDER_COL = 0
# ──────────────────────────────────────────────
